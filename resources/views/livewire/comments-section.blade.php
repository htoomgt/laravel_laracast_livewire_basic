<div class="my-8 space-y-10">
    {{--For success message--}}
    @if(($successMessage))
        <div class="rounded-md bg-green-100 p-4 my-8">
            <div class="flex">
                ...
                <div class="ml-auto pl-3">
                    <div class="-mx-1.5 -my-1.5">
                        <button wire:click="$set('successMessage', '')" type="button"
    ...
    <form wire:submit.prevent="postComment" action="#" method="POST" class="w-1/2 my-12">
        ...
        <div class="flex">
            ...
            <div class="ml-4 flex-1">
                <textarea wire:model.defer="comment" name="comment" id="comment" cols="30" rows="4"
    ...
    @foreach($post->comments->sortDesc() as $comment)
        <div class="flex">
            <img src="https://www.gravatar.com/avatar/?d=mp&f=y" alt="avatar" class="h-10"/>
            <div class="ml-4">
